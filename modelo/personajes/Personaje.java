...
public abstract class Personaje implements Cloneable {
    ...
    public String toString() {        
        return String.format("info del arma: [Raza: %s, arma: " + arma.toString() +", armadura: "+ armadura.toString() +", montura: "+ montura.toString() +", especialidad: %s, edad: %d, altura: %f]", raza, especialidad, edad, altura);
    }  
